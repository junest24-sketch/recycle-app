          ...
          <>
            ...
            <div id="dash-cashflow">
              ...
              {(() => {
                ...
                return (
                  <div style={{ background: "#fff", borderRadius: 12, border: "1px solid #e5e7eb", overflow: "hidden", marginTop: 14 }}>
                    <div style={{ background: "#854f0b", color: "#fff", padding: "12px 16px", fontWeight: 700, fontSize: 14 }}>
